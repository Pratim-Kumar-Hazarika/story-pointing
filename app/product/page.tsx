...
function page() {
  ...
  return (
    <div className='relative'>
        ...
        <div onClick={()=>setPage('product')} className="  cursor-pointer   flex items-center justify-center " >Try Now</div>
         <div onClick={()=>setPage('product')} className="  cursor-pointer   flex items-center justify-center " >Product</div>
  ...
  A fast, real-time tool for agile story point estimation and effortless team collaboration.
</p>
...
{
  page==='price' &&  <div className=' flex items-center justify-center'>
  <PricingCards/>
</div>
}
