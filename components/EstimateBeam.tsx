...
export const EstimateBeam= ({
  ...
  const y1 = useSpring(2000, { stiffness: 500, damping: 90 });
  const y2 = useSpring(2000, { stiffness: 500, damping: 90 });

  return (
    <motion.div
      ref={ref}
      className={cn("absolute border   min-h-screen", className)}
    >
      <div className="absolute z-40 right-[20rem] top-[0rem] -rotate-45">
        <svg
